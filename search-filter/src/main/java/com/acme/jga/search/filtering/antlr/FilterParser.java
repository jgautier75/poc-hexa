...
public class FilterParser extends Parser {
    ...
    public static class ExprContext extends ParserRuleContext {
        public TerminalNode OPAR() {
            return getToken(FilterParser.OPAR, 0);
        }
        ...
        public TerminalNode CPAR() {
            return getToken(FilterParser.CPAR, 0);
        }
        ...
        public TerminalNode PROPERTY() {
            return getToken(FilterParser.PROPERTY, 0);
        }

        public TerminalNode COMPARISON() {
            return getToken(FilterParser.COMPARISON, 0);
        }

        public TerminalNode VALUE() {
            return getToken(FilterParser.VALUE, 0);
        }
