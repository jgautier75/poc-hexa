package com.acme.jga.spi.federation.openbao;
...
public class OpenBaoTest {
    ...
    @Test
    public void OpenBao_Mount_Secrets_Add_Read_Credentials() throws VaultException {
        ...
        GenericContainer openBaoContainer = OpenBaoFactory.createOpenBaoContainer(network, "2.4.4", exposedPort, token);
