...
import com.acme.jga.domain.ports.primary.users.UserDeleteInput;
import com.acme.jga.domain.ports.primary.users.UserFindInput;
...
public class UserDeleteFuncImpl extends UserEventFunc implements UserDeleteInput {
    ...
    public Integer delete(CompositeId tenantId, CompositeId organizationId, CompositeId id) throws FunctionalException {
        ...
        Integer nbDeleted = userDeleteOutput.deleteForOrganization(tenant.id(), user.organizationId(), user.id(), eventData);
