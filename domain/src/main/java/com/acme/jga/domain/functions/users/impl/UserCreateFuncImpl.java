...
public class UserCreateFuncImpl implements UserCreateInput {
    ...
    public UserCreateFuncImpl(OrganizationFindInput organizationFindInput, TenantFindInput tenantFindInput, UserCreateOutput userCreateOutput) {
    ...
    public CompositeId create(User user) throws FunctionalException {
        ...
        User usr = new User(null, tenant.id(), organization.id(),
                ...
                user.status(), user.notifEmail(), user.secrets());
