...
public class SectorFindOutputStub implements SectorFindOuput {

    private final Tenant tenant;
    private final Organization organization;

    public SectorFindOutputStub(Tenant tenant, Organization organization) {
        this.tenant = tenant;
    ...
    public List<Sector> findAll(CompositeId tenantId, CompositeId organizationId) {
        ...
        Sector eastNorthEast = new Sector(new CompositeId(9L, UUID.randomUUID().toString()), tenant.id(), organization.id(), "eastnorthheast", "eastnortheast", northEast.getId(), false, null);
        ...
        return List.of(root, north, south, east, west, northEast, northNorthEast, northWest, eastNorthEast);
    }
}
